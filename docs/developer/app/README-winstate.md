...
* <a href="https://github.com/nwjs/nw.js/wiki/Preserve-window-state-between-sessions" target="_blank">Preserve window state between sessions</a>


## Author

**Jean-Michel _(Jim)_ FAURE** (December 7th, 2020)
